...
Page({
  ...
  onLoad: function (options) {
    this.setData({
      around1: app.globalData.around1,
      around2: app.globalData.around2,
      around3: app.globalData.around3,
    })
  },
   ...
   */
  onReady: function () {
    app.globalData.around1 = this.data.around1;
    app.globalData.around2 = this.data.around2;
    app.globalData.around3 = this.data.around3;
    /*this.setData({
  ...
  Caround2: function (e) {
    this.setData({
      around2: e.detail.value
    });
  },
  Caround3: function (e) {
    this.setData({
      around3: e.detail.value
    });
  },
  countResult: function () {
    ...
    cH.push(app.globalData.around1);
